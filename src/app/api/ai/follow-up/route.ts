...
export async function POST(request: Request) {
  ...
  if (!process.env.OPENAI_API_KEY) return NextResponse.json({ message: `Hi ${leadName}, I wanted to follow up while this is fresh. ${direction} Would you be open to a quick conversation this week?`, demo: true });
